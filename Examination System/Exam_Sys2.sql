...
----------------------------------------------------------------------------------------
 ...
 exec exs.addQuestionToTheBank2 'java does not need semi colon ', 'True&false', 15 , 'false' , 1,1
 exec exs.addQuestionToTheBank2 'html need compiler ?', 'True&false', 15 , 'false' , 4,4
 exec exs.addQuestionToTheBank2 'C++ not case sensitive?', 'True&false', 10 , 'false' , 3,3
 exec exs.addQuestionToTheBank2 'css case sensitive ?', 'True&false', 10 , 'false' , 5,5
 exec exs.addQuestionToTheBank2 'html case sensitive', 'True&false', 10 , 'false' , 4,4
...
------------------------------------------------------------------------------------------
 ...
 exec exs.UpdateQuestion 6,'the updated question',20,'true',3,3    -- no rows affected 
 exec exs.UpdateQuestion 8,'the updated question',20,'true',1,1    -- 1 row affected 
...
exec exs.deleteQuestion 10 , 3 , 3    -- 1  row affected
...
exec exs.putQuestionsInExam 1 , 5 ,20
...
exec  exs.putQuestionsInExamManually 5 , 3 , 2  -- 1 row affected
